...
al siguiente capítulo [Control de Flujo](/capitulos/06-control-de-flujo.md#control-de-flujo)
...
*Código:*
    ...
    puts('El pronosticador del tiempo dijo que hay '+rand(101).to_s+'% probabikidad de que llueva,')
...
Entonces ahora vamos a ver [control de flujo](/capitulos/06-control-de-flujo.md#control-de-flujo).
